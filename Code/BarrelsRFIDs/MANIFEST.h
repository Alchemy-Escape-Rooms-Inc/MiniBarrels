...
// ------------------------------------------------------------
// Feedback lights - one WS2811 bullet string daisy-chained through all
// five barrels in reader order: Vanilla, Cloves, Molasses, SugarCane, Yeast.
// LEDS_PER_BARREL bullets belong to each barrel, in that order along the
// string. If YELLOW shows up as some other color, change LED_COLOR_ORDER
...
#define LEDS_PER_BARREL       1        // bullets wired into each barrel
